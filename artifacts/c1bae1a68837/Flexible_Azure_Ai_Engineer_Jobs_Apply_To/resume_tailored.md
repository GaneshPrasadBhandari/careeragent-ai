...
## Technical Skills
- **AI/ML:** nlp, ai architect, azure ml, azure openai, llm, openai, tensorflow, genai, langchain
- **Cloud Engineering:** azure, aws
- **Data Ops:** machine learning, computer vision, deep learning, power bi, python, r, solution architect, spark, sql, tableau, langgraph
