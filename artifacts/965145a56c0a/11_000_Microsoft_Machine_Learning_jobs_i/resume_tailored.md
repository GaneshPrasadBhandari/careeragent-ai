...
## Technical Skills
- **AI/ML:** openai, ai architect, azure ml, azure openai, llm, nlp, tensorflow, genai, agentic ai, crewai, mlflow
- **Cloud Engineering:** azure, aws
- **Data Ops:** computer vision, machine learning, deep learning, power bi, python, r, solution architect, spark, sql, tableau, mcp, langgraph
