...
## Technical Skills
- **AI/ML:** nlp, ai architect, azure ml, azure openai, llm, openai, tensorflow, genai, agentic ai, crewai, mlflow
- **Cloud Engineering:** azure, aws
- **Data Ops:** computer vision, deep learning, machine learning, solution architect, power bi, python, r, spark, sql, tableau, mcp, langgraph
