...
## Technical Skills
- **AI/ML:** azure ml, ai architect, azure openai, llm, nlp, openai, tensorflow, genai, agentic ai, crewai, mlflow
- **Cloud Engineering:** azure, aws
- **Data Ops:** computer vision, deep learning, machine learning, power bi, python, r, solution architect, spark, sql, tableau, mcp, langgraph
