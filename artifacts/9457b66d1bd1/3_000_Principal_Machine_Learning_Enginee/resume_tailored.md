...
## Technical Skills
- **AI/ML:** ai architect, azure ml, azure openai, llm, nlp, openai, tensorflow, genai, agentic ai, crewai, mlflow
- **Cloud Engineering:** aws, azure
- **Data Ops:** machine learning, computer vision, deep learning, power bi, python, r, solution architect, spark, sql, tableau, mcp, langgraph
