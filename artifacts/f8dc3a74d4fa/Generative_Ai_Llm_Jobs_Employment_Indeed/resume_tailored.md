...
## Technical Skills
- **AI/ML:** genai, llm, ai architect, azure ml, azure openai, nlp, openai, tensorflow
- **Cloud Engineering:** aws, azure
- **Data Ops:** machine learning, computer vision, deep learning, power bi, python, r, solution architect, spark, sql, tableau, claude, gemini
