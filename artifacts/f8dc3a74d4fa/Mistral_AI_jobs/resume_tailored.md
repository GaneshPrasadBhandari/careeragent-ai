...
## Technical Skills
- **AI/ML:** ai architect, azure ml, azure openai, llm, nlp, openai, tensorflow
- **Cloud Engineering:** aws, azure
- **Data Ops:** machine learning, mistral, computer vision, deep learning, power bi, python, r, solution architect, spark, sql, tableau, claude
