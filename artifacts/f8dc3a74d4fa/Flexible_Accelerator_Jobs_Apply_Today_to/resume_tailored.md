...
## Technical Skills
- **AI/ML:** azure ml, openai, ai architect, azure openai, llm, nlp, tensorflow
- **Cloud Engineering:** aws, azure
- **Data Ops:** lambda, machine learning, sagemaker, computer vision, deep learning, power bi, python, r, solution architect, spark, sql, tableau
