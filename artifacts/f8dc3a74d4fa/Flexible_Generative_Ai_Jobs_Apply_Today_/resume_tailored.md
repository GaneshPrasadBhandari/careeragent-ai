...
## Technical Skills
- **AI/ML:** nlp, ai architect, azure ml, azure openai, llm, openai, tensorflow
- **Cloud Engineering:** aws, azure
- **Data Ops:** computer vision, machine learning, python, deep learning, power bi, r, solution architect, spark, sql, tableau, claude, gemini
