...
## Technical Skills
- **AI/ML:** openai, ai architect, azure ml, azure openai, llm, nlp, tensorflow, NLP, GenAI, MLOPs, Azure AI Studio, mlflow
- **Cloud Engineering:** azure, aws, cloud computing, SQL. AWS, Azure, Azure Foundry, Azure Foundary
- **Data Ops:** computer vision, machine learning, deep learning, power bi, python, r, solution architect, spark, sql, tableau, Python, Flask
