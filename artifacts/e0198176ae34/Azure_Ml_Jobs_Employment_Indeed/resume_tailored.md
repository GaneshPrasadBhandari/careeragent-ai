...
## Technical Skills
- **AI/ML:** azure ml, ai architect, azure openai, llm, nlp, openai, tensorflow, NLP, GenAI, MLOPs, Azure AI Studio, mlflow
- **Cloud Engineering:** azure, aws, cloud computing, SQL. AWS, Azure, Azure Foundry, Azure Foundary
- **Data Ops:** computer vision, deep learning, machine learning, power bi, python, r, solution architect, spark, sql, tableau, Python, Flask
